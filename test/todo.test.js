...
describe("todo", () => {
	...
	describe('#isValid', () => {
		it('Should return invalid when creating an object withour text', () => {
			const data ={
				text: '',
		...
		it('Should return invalid when creating an using the "when"', () => {
			const data ={
				text: 'Hello World',
		...
		it('Should have "id", "text", "then" and "status" properties after creating object', () => {
			const data ={
				text: 'Hello World',
				when: new Date('2020-12-01')
			}
